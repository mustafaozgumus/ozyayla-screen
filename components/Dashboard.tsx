...
const Dashboard: React.FC = () => {
  return (
    <div className="relative w-screen h-screen overflow-hidden flex flex-col font-sans text-slate-100 selection:bg-none cursor-none">
      ...
      <main className="relative z-10 flex-1 px-4 pb-4 pt-1 overflow-hidden" style={{ zoom: '0.85' }}>
        <div className="w-full h-full max-w-[95%] mx-auto grid grid-cols-10 gap-3">
